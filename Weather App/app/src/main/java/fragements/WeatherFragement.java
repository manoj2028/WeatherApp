...
public class WeatherFragement extends Fragment implements GoogleApiClient.ConnectionCallbacks,
    ...
    BroadcastReceiver saveBroadcastReceiver;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setRetainInstance(true);
         apiService =
                ApiClient.getClient().create(Response.class);
...
*/
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        IntentFilter intent=new IntentFilter("ResumeActivity");
        getActivity().registerReceiver(saveBroadcastReceiver, intent);
    ...
    void cityload()
    {
        ...
        Call<String> weatherdata=apiService.getCity(Utility.APP_ID,location);
        weatherdata.enqueue(new Callback<String>() {
            @Override
                    ...
                    if (getString("cod", obj).equalsIgnoreCase("200")) {
                        ...
                        for (int i = 0; i < listofarray.length(); i++) {
                            ...
                            if (addWeather) {
                                ...
                                Date date = new Date(Long.parseLong(getString("dt", individuallist)) * 1000);
                                Date currentdate=new Date(System.currentTimeMillis());
                                if(currentdate.equals(date))
                                {
                                    if(System.currentTimeMillis()-date.getTime()<10800000)
                                    {
                                        datalist.add(getdate(Long.parseLong(getString("dt", individuallist))));
...
*/
    ...
    void citylocation(String lat,String lang)
    {
        progressBarCyclic.setVisibility(View.VISIBLE);

        Call<String> weatherdata=apiService.getLocation(Utility.APP_ID,lat,lang);
        weatherdata.enqueue(new Callback<String>() {
            @Override
            public void onResponse(Call<String> call, retrofit2.Response<String> response) {
...
*/
    ...
    public void callWebService() {
        if (Permission.checknetwork(getActivity())) {
            callWeather = new WeatherreportData(this);
            citylocation(""+previouslat,""+previouslang);
...
*/
    ...
    public void onDestroy() {
        super.onDestroy();
        getActivity().unregisterReceiver(saveBroadcastReceiver);
